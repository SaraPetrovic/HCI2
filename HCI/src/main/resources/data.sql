...
insert into ucionica(id, oznaka, opis, broj_mesta, projektor, tabla, pametna_tabla, op_sistem ) values ('1', 'L1', 'opis ucionice', '25', true, true, true, 'WINLINUX')
insert into ucionica(id, oznaka, opis, broj_mesta, projektor, tabla, pametna_tabla, op_sistem ) values ('2', 'L2', 'opis ucionice', '10', false, false, false, 'LINUX')
...
insert into ucionica_softver(ucionica_id, softver_id) values ('4', '1')
insert into ucionica_softver(ucionica_id, softver_id) values ('4', '2')
insert into ucionica_softver(ucionica_id, softver_id) values ('4', '4')
